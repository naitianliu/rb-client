...
class AppSettingsTableViewController: UITableViewController, UIActionSheetDelegate {
    ...
    override func viewDidLoad() {
        ...
        var dismissButtonItem:UIBarButtonItem = UIBarButtonItem(title: "Done", style: UIBarButtonItemStyle.Done, target: self, action: "dismissCurrentView")
